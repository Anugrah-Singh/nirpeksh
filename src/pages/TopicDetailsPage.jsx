...
function TopicDetailsPage() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-blue-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-center items-center h-64">
          <div className="animate-pulse flex flex-col items-center space-y-4">
            <div className="h-10 bg-teal-300 rounded-full w-1/2"></div>
            <div className="space-y-2 w-full">
              <div className="h-4 bg-teal-200 rounded-full w-3/4 mx-auto"></div>
              <div className="h-4 bg-teal-200 rounded-full w-1/2 mx-auto"></div>
              <div className="h-4 bg-teal-200 rounded-full w-2/3 mx-auto"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-blue-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white bg-opacity-80 backdrop-blur-sm border border-red-200 rounded-xl p-8 text-center shadow-lg">
          ...
          <Link to="/dashboard" className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition duration-150">
            Return to Dashboard
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-blue-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <Link 
            to="/dashboard" 
            className="inline-flex items-center text-teal-600 hover:text-teal-800 font-medium group transition duration-150"
          >
          ...
          <div className="flex items-center space-x-2 text-gray-500">
            ...
            <span className="text-sm md:text-base bg-teal-100 px-3 py-1 rounded-full font-mono">{topicId}</span>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-start">
            <h1 className="pr-3 text-3xl sm:text-4xl md:text-5xl font-bold text-teal-900 bg-gradient-to-br from-teal-50 to-blue-100">
        ...
        {/* Brief Section */}
        <section className="bg-white bg-opacity-80 backdrop-blur-sm rounded-xl shadow-md border border-teal-100 overflow-hidden transition-all duration-300 hover:shadow-lg">
          <div className="border-b border-teal-100 bg-teal-50 px-6 py-4 flex items-center">
            ...
            <h3 className="text-xl font-semibold text-teal-800">Brief Overview</h3>
          </div>
          <div className="p-6">
            <ReactMarkdown
              components={{
        ...
        <section className="bg-white bg-opacity-80 backdrop-blur-sm rounded-xl shadow-md border border-teal-100 overflow-hidden transition-all duration-300 hover:shadow-lg">
          <div className="border-b border-teal-100 bg-teal-50 px-6 py-4 flex items-center">
            ...
            <h3 className="text-xl font-semibold text-teal-800">Balanced Perspective</h3>
          </div>
          <div className="p-6">
            <ReactMarkdown
              components={{
        ...
        <section className="bg-white bg-opacity-80 backdrop-blur-sm rounded-xl shadow-md border border-teal-100 overflow-hidden transition-all duration-300 hover:shadow-lg">
          <div className="border-b border-teal-100 bg-teal-50 px-6 py-4 flex items-center">
            ...
            <h3 className="text-xl font-semibold text-teal-800">Related Articles</h3>
          </div>
          <div className="p-6">
            {topicDetails.related_articles && topicDetails.related_articles.length > 0 ? (
              ...
              <div className="text-center py-12">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-teal-300 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <section className="bg-white bg-opacity-80 backdrop-blur-sm rounded-xl shadow-md border border-teal-100 overflow-hidden transition-all duration-300 hover:shadow-lg">
          <div className="border-b border-teal-100 bg-teal-50 px-6 py-4 flex items-center">
            ...
            <h3 className="text-xl font-semibold text-teal-800">Topic Assistant</h3>
          </div>
          <div className="p-6">
            <ChatBot />
          </div>
